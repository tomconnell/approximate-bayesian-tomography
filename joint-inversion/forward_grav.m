function [simulated_data] = forward_grav(simulated_parameters)
...
% MESH
height=10000*(4/6);    % rectangles vertical dimension (m)
width=20000*(8/20);    % rectangles horizontal dimension (m)
nx = 20;    % number of rectangles in the x-direction
ny = 6;    % number of rectangles in the y-direction
...
obs_points = linspace(0+(width*0.5),domain_width-(width*0.5),number_of_observations);
