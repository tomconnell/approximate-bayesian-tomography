...
% MESH
height=10000;    % rectangles vertical dimension (m)
width=20000;    % rectangles horizontal dimension (m)
nx = 8;    % number of rectangles in the x-direction
ny = 4;    % number of rectangles in the y-direction
